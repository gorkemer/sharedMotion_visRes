...
jsPsych.plugins['virtual-chinrest'] = (function() {
  ...
  plugin.info = {
    ...
    parameters: {
      ...
      adjustment_prompt: {
        type: jsPsych.plugins.parameterType.STRING,
        default: '<b> Welcome! Before the instructions, Let&#39s find out how big your monitor is! </b>'+
                  ...
                  '<b>Place your card flat onto the screen, and adjust from <b style="color: red">red</b> corner below to match its size.</b></p>'+
      ...
      blindspot_prompt: {
        type: jsPsych.plugins.parameterType.STRING,
        default: '<b>Now, let&#39s quickly test how far away you are sitting.</b>'+
                  '<p>You might know that vision tests at a doctor&#39s practice often involve chinrests.<br>'+
                  'The doctor basically asks you to sit away from a screen in a specific distance.<br>'+
                  'We do this here with a &#34virtual chinrest&#34.</p><br>'+
                  '<b>Instructions</b>'+
                  ...
                  '<li>Using your left eye, focus on the black square (while the ball moves keep your left-eye fixed on the square).</li>'+
                  '<li>Click the button below to start the animation of the red ball. The <b style="color: red">red ball </b>'+
                  'will disappear as it moves from right to left. Press the &#34Space&#34 key as soon as the ball disappears from your eye sight.</li>'+
                  '</div><br> Keep your right eye closed and hit the &#34Space&#34 key fast!</p><br>'
      },
